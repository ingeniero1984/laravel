<nav class="navbar navbar-light navbar-expand-md bg-dark shadow-sm">

	<div class="container">
	
		<a class="navbar-brand" href="{{ route('home') }}">
			Ing. Lermy Ferrer Peralta.
		</a>
		...
		<ul class="nav nav-pills ml-auto">
			...
			<li class="nav-item">
				<a class="nav-link {{ setActive('tecnology') }}" href="{{ route('tecnology') }}">@lang('Tecnology')</a>
			</li>
			...
			@auth
				...
				<li class="nav-item">
					<a class="nav-link {{ setActive('tecnology') }}" href="#" onclick="event.preventDefault();
